...
const WhatsNew = () => {
  ...
  const messages = [
    "Find the github repository of this MSN clone <a target='_blank' href='https://github.com/clrgia/wlm' class='link'>here</a>!",
    "This app is under construction, so don't be surprised to find bugs or missing features",
  ];
